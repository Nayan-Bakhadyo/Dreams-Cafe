                ...
                <div class="container-fluid centered ">
                         <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h1 class="card-header text-center">New Order</h1><hr>
                                    <div class="card-body">
                                        <form action="add_order_process.php?food_id=<?php echo $food_id ?>" method="post">
                                        ...
                                        <?php
                                         ...
                                         ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="quantity" name="quantity" type="number"  class="form-control" Required style="font-size:22px; font-weight:bold; height:auto;">
                                                
                                            </div>
                                           <hr>
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1" style="font-size:28px; font-weight:bold;">Remark:</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" cols="5" style="font-size:22px; font-weight:bold; height:auto; align:left;" name="remark" id="remark"> </textarea>
                                            </div>
                                            <hr>
